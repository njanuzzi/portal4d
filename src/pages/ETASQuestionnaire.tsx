...
export function ETASQuestionnaire() {
  ...
  return (
    <div className="min-h-screen bg-[#032a3c] text-white font-sans">
      ...
      <div className="max-w-md mx-auto px-6 py-10">
        ...
        {step === 'identity' && (
          <>
            <h1 className="font-serif text-2xl text-center mb-3 text-balance">Escala Triangular do Amor</h1>
            <p className="text-petrol-100/70 text-sm text-center leading-relaxed mb-8">
              Esse questionário tem 16 perguntas e leva cerca de 8 minutos.
            </p>
          ...
          <>
            <div className="mb-6">
              <div className="flex items-center justify-between text-xs text-petrol-100/60 mb-1.5">
                <span>Escala Triangular do Amor</span>
