...
import { Smile, ChevronRight, Download } from 'lucide-react';
...
export function ENSRAResponsesRepository() {
  ...
  const handleExportAll = () => {
    ...
    downloadCsv(`respostas-ensra-${new Date().toISOString().split('T')[0]}.csv`, csv);
  };
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-dark font-serif">Respostas da ENSRA-R</h1>
          <p className="text-dark/50 text-sm mt-0.5">Todas as submissões da Escala de Satisfação com o Relacionamento, de todos os clientes</p>
        </div>
      </div>
      ...
      {filteredAssessments.length === 0 ? (
        <EmptyState
          ...
          description="As submissões da ENSRA-R vão aparecer aqui"
        />
      ) : (
        <Card>
