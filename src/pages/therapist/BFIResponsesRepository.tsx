...
import { UserCircle, ChevronRight, Download } from 'lucide-react';
...
export function BFIResponsesRepository() {
  ...
  const handleExportAll = () => {
    ...
    downloadCsv(`respostas-bfi-${new Date().toISOString().split('T')[0]}.csv`, csv);
  };
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-dark font-serif">Respostas do BFI</h1>
          <p className="text-dark/50 text-sm mt-0.5">Todas as submissões do Big Five Inventory, de todos os clientes</p>
        </div>
      </div>
      ...
      {filteredAssessments.length === 0 ? (
        <EmptyState
          ...
          description="As submissões do Big Five Inventory vão aparecer aqui"
        />
      ) : (
        <Card>
