...
export function ECRResponsesRepository() {
  ...
  const handleExportAll = () => {
    ...
    downloadCsv(`respostas-ecr-${new Date().toISOString().split('T')[0]}.csv`, csv);
  };
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-dark font-serif">Respostas da ECR-R</h1>
          <p className="text-dark/50 text-sm mt-0.5">Todas as submissões da Escala de Experiências em Relacionamentos Íntimos, de todos os clientes</p>
        </div>
      </div>
      ...
      {filteredAssessments.length === 0 ? (
        <EmptyState
          ...
          description="As submissões da ECR-R vão aparecer aqui"
        />
      ) : (
        <Card>
