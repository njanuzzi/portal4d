...
const STORAGE_KEY = 'portal_marq_draft';
...
export function MARQQuestionnaire() {
  ...
  // Carrega as 9 perguntas (público, sem login) e tenta retomar um rascunho
  // salvo no localStorage — igual o acesso sem login do BFI/SMI/YSQ.
  useEffect(() => {
    const load = async () => {
  ...
  return (
    <div className="min-h-screen bg-[#032a3c] text-white font-sans">
      ...
      <div className="max-w-md mx-auto px-6 py-10">
        ...
        {step === 'identity' && (
          <>
            <h1 className="font-serif text-2xl text-center mb-3 text-balance">Escala de Amor (MARQ)</h1>
            <p className="text-petrol-100/70 text-sm text-center leading-relaxed mb-8">
              Esse questionário tem 9 perguntas e leva de 3 a 5 minutos.
            </p>
        ...
        {step === 'welcome' && (
          <>
            ...
            <div className="space-y-5 text-sm text-petrol-100/85 leading-relaxed mb-8">
              <p>
                Por favor, leia as perguntas a seguir e responda de acordo com a escala. Observe que 1 significa
                "Nem um pouco" e 5 significa "Muito". Considere seu relacionamento atual para responder.
              </p>
            </div>
