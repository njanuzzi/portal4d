...
function AppRoutes() {
  ...
  // ECR-R questionnaire (Experiências em Relacionamentos Íntimos) is always public
  if (location.pathname === '/questionario-ecr') {
    return (
      <Routes>
        <Route path="/questionario-ecr" element={<ECRQuestionnaire />} />
      </Routes>
    );
  }
