/** Atlas de Padrões — menu móvel da navegação pública. */
import { useEffect } from 'react';
import { Link } from 'react-router-dom';
import { ArrowUpRight, X } from 'lucide-react';

const links = [
  { number: '01', label: 'O método', to: '/protocolo4d' },
  { number: '02', label: 'Atendimento', to: '/atendimento' },
  { number: '03', label: 'Conteúdos', to: '/conteudos' },
